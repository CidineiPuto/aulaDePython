...
# __new__(mcs ( meta class ), name ( nome da classe ), bases ( heranças ), dct) (Cria a classe)
...
Foo = type('Foo', (object,), {}) # cria  nova classe

f = Foo() # f é uma instância ( é do tipo ) de foo 
