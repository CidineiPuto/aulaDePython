...
class Banco:
    ...
    def checa_conta_e_do_cliente(self, cliente, conta):
        if conta is cliente.conta:
            print('checa_conta_e_do_cliente', True)
            return True
        print('checa_conta_e_do_cliente', False)
        return False
    ...
    def autenticar(self, cliente: pessoas.Pessoa, conta: contas.Conta):
        return self._checa_agencia(conta) and \
            ...
            self.checa_conta_e_do_cliente(cliente, conta)
...
if __name__ == '__main__':
    ...
    cc1 = contas.Conta_Corrente(111, 222, 0, 0)
    c1.conta = cc1
    c2 = pessoas.Cliente('Maria', 18)
    cp1 = contas.Conta_Poupanca(112, 223, 100)
    c2.conta = cp1
    banco = Banco()
