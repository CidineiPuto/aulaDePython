...
class Log(ABC): # Ou (metaclass=ABCMeta)

    @abstractmethod # torna a classe abstrada 
    def _log(self,msg):...
...
class LogPrintMixin(Log):
    def _log(self,msg): # É necessário implementar o método abstrado com o corpo, e lembre de manter a assinatura
